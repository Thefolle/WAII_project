...
import it.polito.waii.warehouse_service.dtos.UserDTO
...
class JwtUtils {
    ...
    fun validateJwtToken(authToken: String): Boolean {
        ...
        try {
            ...
            throw ResponseStatusException(HttpStatus.UNAUTHORIZED, "The authentication session has expired. You must login again.")
